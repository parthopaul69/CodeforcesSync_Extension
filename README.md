<div align="center">
  ...
  <p><b>Automated synchronization of your accepted Codeforces submissions directly to your GitHub.</b></p>
</div>
...
│   ├── Div. 2/                                 # Division-based categorization
│   │   └── 4A - Theatre Square/                # Problem specific folder
│   │       ├── 4A - Theatre Square.cpp         # Accepted source code 
│   │       └── README.md                       # Scraped problem statement
├── 1200/
│   ├── Div. 3/
│   │   └── 1100C - Some Problem/
│   │       ├── 1100C - Some Problem.java
│   │       └── README.md
```
